...
description: Dialect × modality × provider kind
group: reference
order: 10
---
...
Official SDK wire coverage (headers, happy paths, no live keys): **[sdk-compatibility-matrix.md](/llm-gateway/sdk-compatibility-matrix/)**.
...
- [Deprecation / field drops](/llm-gateway/deprecation-policy/)
- [Claude Code checklist](/llm-gateway/claude-code-checklist/)