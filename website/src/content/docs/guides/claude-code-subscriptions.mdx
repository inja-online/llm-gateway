...
Sources: [Claude models](https://platform.claude.com/docs/en/about-claude/models/overview) · [GPT-5.6](https://openai.com/index/gpt-5-6/) · [xAI models](https://docs.x.ai/developers/models). Edit targets if your plan exposes different ids.
| `grok` / `grok-4.5` | `xai/grok-4.5` |
