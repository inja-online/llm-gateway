...
# Switch Claude Desktop + Claude settings + Codex between gateway and defaults:
apps-use-gateway                   # snapshot current files as "default", write gateway
apps-status
# … later, back to vendor defaults:
apps-use-default                   # restore profile "default"
```
...
| [`examples/shell/apps-helpers.sh`](https://github.com/inja-online/llm-gateway/blob/master/examples/shell/apps-helpers.sh) | `apps-use-gateway`, `apps-use-default`, `apps-status`, … |
