...
Use the **Claude desktop application** with the same local gateway and **consumer subscriptions** as Claude Code: ChatGPT (Codex OAuth), Claude (setup-token), SuperGrok (Grok CLI / device OAuth), Gemini / Antigravity (Jetski import).
