---
title: Contributing
description: How to develop and land changes
group: project
order: 30
---
...
Default CI is air-gapped (`httptest` only; no `-tags live`). See [SDK hermetic matrix](/llm-gateway/sdk-compatibility-matrix/).