---
title: Claude Code
description: Point Claude Code at the gateway
group: start
order: 2
---
...
| OpenAI-only fields | Dropped on translate (see [deprecation-policy.md](/llm-gateway/deprecation-policy/)) |
...
- [compatibility-matrix.md](/llm-gateway/compatibility-matrix/)