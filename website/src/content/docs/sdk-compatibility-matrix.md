---
title: SDK hermetic matrix
description: CI test anchors, no live vendors
group: reference
order: 11
---

**Last updated:** 2026-07-19  
**Related:** [compatibility-matrix.md](/llm-gateway/compatibility-matrix/) (modality × provider kind) · [claude-code-checklist.md](/llm-gateway/claude-code-checklist/)
...
4. Update this file and [compatibility-matrix.md](/llm-gateway/compatibility-matrix/) “Related” links.

## Related

- End-to-end modality matrix: [compatibility-matrix.md](/llm-gateway/compatibility-matrix/)
- Claude Code / Anthropic checklist: [claude-code-checklist.md](/llm-gateway/claude-code-checklist/)
