...
- [Claude Code + ChatGPT / SuperGrok / Gemini subscriptions](/llm-gateway/guides/claude-code-subscriptions/) — OAuth login, PATH wrappers, live models  
...
- [Operator dashboard](/llm-gateway/guides/dashboard/) — `/ui` profiles, usage, logs  
...
Use ChatGPT Plus/Pro, Claude Pro/Max, SuperGrok, and/or Gemini / Antigravity through Claude Code, Cursor, Desktop apps, and more.
...
cc-gateway-up
cc-gpt                               # or cc-grok / cc-gemini / cc-multi / cursor-apply / apps-use-gateway
