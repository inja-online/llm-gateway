...
Use with Claude Code: [Claude Code + subscriptions](/llm-gateway/guides/claude-code-subscriptions/) (`cc-grok` → Grok 4.5 / 4.6 + Composer 2.5). Also [Claude app](/llm-gateway/guides/claude-desktop-subscriptions/) and [Codex](/llm-gateway/guides/codex-subscriptions/).
