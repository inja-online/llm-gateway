---
title: "Groq Stt"
description: "Use **Groq for speech-to-text** while keeping **chat on another provider** (OpenAI, Anthropic, etc."
sidebar:
  order: 2
  label: "Groq Stt"
  group:
...
- [xAI provider guide](/xai/) — same `openai_compat` capability pattern for media
