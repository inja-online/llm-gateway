...
description: Translation field drops and fidelity rules
group: reference
order: 12
---
...
- [CHANGELOG.md](/llm-gateway/changelog/)
- [docs/compatibility-matrix.md](/llm-gateway/compatibility-matrix/)
- [docs/sdk-compatibility-matrix.md](/llm-gateway/sdk-compatibility-matrix/)
