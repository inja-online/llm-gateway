---
title: "SDK matrix"
description: "This document is the **hermetic** strategy for official OpenAI / Anthropic / Google client SDK shapes against the gateway."
sidebar:
  order: 2
  label: "SDK matrix"
  group:
...
**Related:** [compatibility-matrix.md](/compatibility-matrix/) (modality × provider kind) · [claude-code-checklist.md](/claude-code-checklist/)
...
4. Update this file and [compatibility-matrix.md](/compatibility-matrix/) “Related” links.

## Related

- End-to-end modality matrix: [compatibility-matrix.md](/compatibility-matrix/)
- Claude Code / Anthropic checklist: [claude-code-checklist.md](/claude-code-checklist/)
