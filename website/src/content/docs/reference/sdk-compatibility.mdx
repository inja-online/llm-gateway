---
title: "SDK matrix"
description: "Hermetic coverage strategy for official OpenAI, Anthropic, and Google client shapes — no live vendor keys in default CI."
sidebar:
  order: 2
  label: "SDK matrix"
  group:
...
**Related:** [Compatibility matrix](/llm-gateway/reference/compatibility-matrix/) · [Claude Code](/llm-gateway/guides/claude-code/)

How we keep official SDK wire contracts honest **without** live vendor calls in default CI. This is **not** a live certification matrix.
...
4. Update this file and [Compatibility matrix](/llm-gateway/reference/compatibility-matrix/) “Related” links.

## Related

- End-to-end modality matrix: [Compatibility matrix](/llm-gateway/reference/compatibility-matrix/)
- Claude Code / Anthropic checklist: [Claude Code](/llm-gateway/guides/claude-code/)
