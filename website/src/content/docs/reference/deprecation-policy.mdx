...
description: "How field drops, observe_dropped_fields, and semver work when translation cannot map a vendor field."
sidebar:
  order: 4
...
- Anthropic `cache_control` preserved on Anthropic family (PT + translate IR); **dropped** cross-family — see [Prompt caching](/llm-gateway/guides/cache-control-policy/) (#108)
...
- [SDK matrix](/llm-gateway/reference/sdk-compatibility/)
