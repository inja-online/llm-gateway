...
description: "Passthrough regressions that strip headers or body keys are **bugs**, not deprecations."
sidebar:
  order: 4
...
- Anthropic `cache_control` preserved on Anthropic family (PT + translate IR); **dropped** cross-family — see [cache-control-policy.md](/cache-control-policy/) (#108)
...
- [docs/sdk-compatibility-matrix.md](/sdk-compatibility-matrix/)
