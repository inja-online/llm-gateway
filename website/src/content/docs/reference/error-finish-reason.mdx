---
title: "Error & finish/stop reasons"
description: "Dialect error envelopes and the universal finish_reason / stop_reason mapping catalog."
sidebar:
  order: 20
  label: "Errors & stop reasons"
  group:
    label: "Reference"
---
